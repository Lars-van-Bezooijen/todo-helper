...
<body>
    ...
    @php  
    // Set the darkMode variable
    // In a real world scenario, you would use user preference set in the database
        $darkMode = true;
    @endphp

    {{-- Check if darkMode is true, if so, add the dark class --}}
    <div @if($darkMode) class="dark" @endif>
        {{-- Navbar --}}
